                ...
                return (
                  <div key={mod.key} className={`bg-white border rounded-xl p-5 flex flex-col h-full transition-shadow hover:shadow-md ${
                    ...
                    <div className="pt-4 border-t border-gray-50 mt-auto">
                      ...
                      {/* 
                        Logic:
                        - If it's a core plan feature (and active), usually can't disable it easily (unless we allow disabling plan features via override=false).
                        - If it's an add-on, we can toggle it.
                        - For now, let's allow toggling everything via overrides for flexibility, 
                          but maybe warn or lock core features?
                          The backend `set_override` allows enabling/disabling anything.
                      */}
                      <button
