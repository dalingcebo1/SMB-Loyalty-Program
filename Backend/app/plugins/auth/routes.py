...
def _role_capabilities(role: str) -> List[str]:
    base = {
        ...
        'staff': ['loyalty.view','orders.create','orders.view','orders.manage_active','payments.verify','payments.view','vehicles.view','vehicles.update','reports.view','retail.products.read','retail.inventory.read','retail.suppliers.read','retail.categories.read','pos.sales.write','pos.sales.read','padel.view_bookings','padel.create_booking','padel.cancel_booking','padel.check_in_players','flowershop.process_orders','flowershop.view_orders','flowershop.schedule_delivery','flowershop.view_products'],
        'admin': ['loyalty.view','orders.create','orders.view','orders.manage_active','payments.verify','payments.view','vehicles.view','vehicles.update','tenant.edit','services.manage','pricing.update','users.invite','users.role.update','analytics.advanced','audit.view','jobs.view','jobs.retry','rate_limit.edit','security.ip_ban','rewards.adjust','exports.generate','config.version.view','platform.manage_tenants','manage_customers','view_reports','manage_notifications','manage-settings','reports.view','retail.products.read','retail.products.write','retail.inventory.read','retail.inventory.write','retail.suppliers.read','retail.suppliers.write','retail.categories.read','retail.categories.write','pos.sales.write','pos.sales.read','padel.manage_courts','padel.manage_time_slots','padel.manage_pricing','padel.view_all_bookings','padel.manage_tournaments','padel.manage_equipment','padel.view_bookings','padel.create_booking','padel.cancel_booking','padel.check_in_players','flowershop.manage_products','flowershop.manage_collections','flowershop.manage_delivery','flowershop.view_all_orders','flowershop.manage_subscriptions','flowershop.process_orders','flowershop.view_orders','flowershop.schedule_delivery','flowershop.view_products'],
