...
const en: Dictionary = {
  ...
  'onboarding.title.profile': { message: 'Complete Your Profile' },
  'onboarding.title.phone': { message: 'Verify Your Phone' },
  'onboarding.subtitle.profile': { message: 'Help us personalize your experience' },
  'onboarding.subtitle.phone': { message: 'We\'ll send you a verification code' },
  'onboarding.button.continuePhone': { message: 'Continue to Phone Verification' },
  'onboarding.button.updating': { message: 'Updating…' },
  'onboarding.button.sendCode': { message: 'Send Verification Code' },
  'onboarding.button.sending': { message: 'Sending…' },
  'onboarding.security.preparing': { message: 'Preparing Security Check…' },
  'onboarding.checkbox.subscribe.label': { message: 'Subscribe to updates' },
  'onboarding.checkbox.subscribe.helper': { message: 'Get promotional offers and loyalty updates' },
  'onboarding.helper.phone.format': { message: 'We accept local numbers (073…) and full international format (+27…)' },
  // Analytics
