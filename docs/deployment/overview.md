...
(Imported from root `AZURE_DEPLOYMENT_OVERVIEW.md`)

This overview unifies the end-to-end production deployment process for the SMB Loyalty Program across the Backend (Azure Container Apps) and Frontend (Azure Static Web Apps) along with supporting workflows.

Short summary and pointer: For procedural steps and runbook, see `docs/deployment/runbook.md`.
