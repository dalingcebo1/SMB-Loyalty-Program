...
const VisitsMetrics: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    api.get(`/analytics/visits/details?start_date=${startDate}&end_date=${endDate}`)
  ...
  if (!data) return <p>No visit metrics to display.</p>;
  ...
  return (
    <div className="p-4">
      ...
      <h2 className="text-xl font-semibold mb-2">Visit Metrics</h2>
