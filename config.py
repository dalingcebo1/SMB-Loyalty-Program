...
_backend_config = _imp('Backend.config')  # type: ignore

# Re-export its public API
Settings = getattr(_backend_config, 'Settings')  # type: ignore
get_settings = getattr(_backend_config, 'get_settings')  # type: ignore
settings = getattr(_backend_config, 'settings')  # type: ignore
